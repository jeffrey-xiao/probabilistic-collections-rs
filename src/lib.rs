...
//! randomization to improve on running time or memory, but introduce a certain amount of error. The
//! error can be controlled under a certain threshold which makes these data structures extremely
//! useful for big data and streaming applications.
//!
//! ## Usage
//!
...
//! ## References
//!
//!  - [Advanced Bloom Filter Based Algorithms for Efficient Approximate Data De-Duplication in
//!    Streams](https://arxiv.org/abs/1212.3964)
...
//!    applications](https://dl.acm.org/citation.cfm?id=1073718)
...
//!    estimation algorithm](https://dl.acm.org/citation.cfm?id=2452456)
...
//!  > Flajolet, Philippe, Éric Fusy, Olivier Gandouet, and Frédéric Meunier. 2007. "Hyperloglog:
//! The Analysis of a Near-Optimal Cardinality Estimation Algorithm." In *IN Aofa '07: PROCEEDINGS
//! of the 2007 International Conference on Analysis of Algorithms*.
//!  - [Less hashing, same performance: Building a better Bloom
//!    filter](https://dl.acm.org/citation.cfm?id=1400125)
...
//!    abstract)](https://dl.acm.org/citation.cfm?id=276781)
...
//!    simhash](https://dl.acm.org/citation.cfm?id=2063737)
